def fun_with_ids
  ...
  # I expect this to be a unique id
  b_outer_id = b_outer.object_id
  # I expect this to be a unique id
  c_outer_id = c_outer.object_id
  # I expect this to be a unique id
  d_outer_id = d_outer.object_id
  # I expect this to be of the same ID as 42 seing as they are the same object
  ...
  1.times do
    # I would expect these to be the same ID's as the outer ids?
    ...
    a_outer = 22
    # I expect this to be a NEW unique id
    b_outer = "thirty three"
    # I expect this to be a NEW unique id
    c_outer = [44]
    # I expect this to be a NEW unique id
    d_outer = c_outer[0]
    # I expect this to be the same id that would use for the integer 44
